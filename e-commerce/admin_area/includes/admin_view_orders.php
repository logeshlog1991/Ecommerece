		...
		<table align="center" style="margin-top:20px;" width="600px">
				...
				?>
					<tr style="height:50px;">
						...
						<td align="center">
							<img src="product_images/<?php echo $row['product_img1']; ?>" width="50" height="50" />
						</td>
						<td align="center" valign="middle">							
						...
						<td align="center" valign="middle">
							<a href="index.php?update_order=<?php echo $c_order['order_id'];?>" style="color:#FA5858;text-decoration:none;">Complete Order</a>
						</td>
					</tr>
					<?php 
					}
